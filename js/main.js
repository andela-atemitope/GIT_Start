...
function withdraw(){
    ...
    if (confirmPassword === localStorage['password']){
		if (amount > 0){
...
function welcomeUser(){
    alert(document.write("<p> Hello," + localStorage['firstName'] ));
}

function displayBalance(){
    document.write("<p>Hello, " + localStorage['firstName'] + ",<br/> Your account balance is " + localStorage['balance'] + ".</p>");
}
